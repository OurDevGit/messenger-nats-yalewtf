...
const GoogleIcon = ({ color, ...rest }) => (
  <svg enableBackground="new 0 0 30 30" id="Social_Icons" version="1.1" viewBox="0 0 128 128" space="preserve" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" className="google">
    <title>Combined Shape</title>
    <g id="_x31__stroke">
      <g id="Google">
        <rect clipRule="evenodd" fill="none" fillRule="evenodd" height="30" width="30"/>
